...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'invites_inviteemails', (
            ...
            ('throughfb', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('throughtwitter', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
    ...
    models = {
        u'invites.inviteemails': {
            ...
            'throughfb': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'throughtwitter': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        }
    }
